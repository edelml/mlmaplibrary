...
public class PreferenceHelper {
    ...
    public static PreferenceHelper getInstance(){
        if(instance==null){
            ...
            instance.prefs = PreferenceManager.getDefaultSharedPreferences(GoblobLocationManager.getInstance().getApplicationContext());
        }
    ...
    public String getFtpDirectory() {
        return prefs.getString(PreferenceNames.FTP_DIRECTORY, "Goblob");
    }
     ...
     */
    @ProfilePreference(name= PreferenceNames.GOBLOB_FOLDER)
    public String getGoblobFolder() {
        return prefs.getString(PreferenceNames.GOBLOB_FOLDER, Files.storageFolder(GoblobLocationManager.getInstance().getApplicationContext()).getAbsolutePath());
    }
     ...
     */
    public void setGoblobFolder(String folderPath) {
        prefs.edit().putString(PreferenceNames.GOBLOB_FOLDER, folderPath).apply();
    }
    ...
    public String getGoogleDriveFolderName() {
        return prefs.getString(PreferenceNames.GOOGLEDRIVE_FOLDERNAME, "Goblob for Android");
    }
    ...
    public String getCustomFileName() {
        return prefs.getString(PreferenceNames.CUSTOM_FILE_NAME, "goblob");
    }
    ...
    public String getOwnCloudDirectory() {
        return prefs.getString(PreferenceNames.OWNCLOUD_DIRECTORY, "/goblob");
    }
    ...
    public String getCurrentProfileName() {
        return prefs.getString(PreferenceNames.CURRENT_PROFILE_NAME, GoblobLocationManager.getInstance().getApplicationContext().getString(R.string.profile_default));
    }
