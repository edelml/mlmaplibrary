...
package com.ml.map.gpx;

import android.location.Location;

import com.ml.map.BuildConfig;
import com.ml.map.BundleConstants;
import com.ml.map.FileLogger;
import com.ml.map.Files;
import com.ml.map.Maths;
import com.ml.map.RejectionHandler;
...
class Gpx10WriteHandler implements Runnable {
    ...
    String getBeginningXml(String dateTimeString){
        ...
        initialXml.append("<gpx version=\"1.0\" creator=\"Goblob " + /*BuildConfig.VERSION_CODE*/1 + " - http://goblob.com/\" ");
