...
public class Segment implements Parcelable {
    ...
    private int endPointPos;

    /**
     * Create an empty_base segment.
     */
    ...
    public Segment copy() {
        ...
        copy.startPointPos = startPointPos;
        copy.endPointPos = endPointPos;
        return copy;
    }
    ...
    public void setStartPointPos(int startPointPos) {
        this.startPointPos = startPointPos;
    }

    public int getStartPointPos() {
        return startPointPos;
    }

    public void setEndPointPos(int endPointPos) {
        this.endPointPos = endPointPos;
    }

    public int getEndPointPos() {
        return endPointPos;
    }
}
