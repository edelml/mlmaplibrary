...
public class GoogleParser extends XMLParser implements Parser {
    ...
    public GoogleParser(String feedUrl, LatLng origin, LatLng destination, AbstractRouting.TravelMode travelMode) {
        super(feedUrl);
        this.origin = origin;
        ...
        try {
            ...
            for (int i = 0; i < jsonRoutes.length(); i++) {
                ...
                for (int y = 0; y < numSteps; y++) {
                    ...
                    segment.setStartPointPos(route.getPoints().size());
                    route.addPoints(points);
                    segment.setEndPointPos(route.getPoints().size() -1);
