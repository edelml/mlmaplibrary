...
public class Route implements Parcelable {
    ...
    public boolean updateOrigin(Location bestLocation) {
        if (origin == null){
            origin = new LatLng(bestLocation.getLatitude(), bestLocation.getLongitude());
            return destination != null;
        } else if (SphericalUtil.computeDistanceBetween(origin, new LatLng(bestLocation.getLatitude(), bestLocation.getLongitude())) > 10){
            origin = new LatLng(bestLocation.getLatitude(), bestLocation.getLongitude());
            return destination != null;
        }
        return false;
    ...
    public void setTravelMode(AbstractRouting.TravelMode travelMode) {
        this.travelMode = travelMode;
    }

    public AbstractRouting.TravelMode getTravelMode() {
        return travelMode;
    }
